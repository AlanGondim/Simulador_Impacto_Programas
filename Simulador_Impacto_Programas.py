...
if aba == "Nova Análise":
    ...
    with cc1: receita = st.number_input("2.1. Receita Líquida (R$)", min_value=0.0, value=1000,0,step=1000,0)
    with cc2: custos_at = st.number_input("2.2. Custos totais (R$)", min_value=0.0, value=1000,0,step=1000,0)
    with cc3:
